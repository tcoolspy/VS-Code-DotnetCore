...
namespace dotnetPartThree.Data
{
    public class NorthwindContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=localhost;Database=Northwind;User Id=sa;Password=JoinTheBank19");                
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.Property(e => e.TitleOfCourtesy).HasMaxLength(30);
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.CustomerId).HasColumnName("CustomerID").HasMaxLength(15);
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasOne(d => d.Category)
                    ...
                    .HasConstraintName("FK_Prodoucts_Categories");
